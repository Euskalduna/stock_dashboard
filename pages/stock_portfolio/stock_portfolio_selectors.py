...
def get_page_general_selector_row():
    ...
    selector_row = dbc.Row([
        ...
        dbc.Col([
            dbc.Row(dbc.Col([html.H3("Moneda: ")])),
            dbc.Row(dbc.Col(
                [dcc.Dropdown(
                    options=[option_dict['value'] for option_dict in currency_option_dict_list],
                    value='Euro',
                    clearable=False,
                    id="currency_dropdown_selector",
                )]
            )),
        ], width=2),
