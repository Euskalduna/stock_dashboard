...
from pages.obtained_dividends.page_components.panels.kpi_indicators import get_kpi_indicators_panel
...
def get_panels(obtained_dividends_df):
    ...
    # Panel del PIE CHART
    weight_criteria_column = "brute_obtained_money_in_euros"
